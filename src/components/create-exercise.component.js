...
export default class CreateExercise extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:1000/exercises/add', exercise)
            ...
            <div>
               ...
               <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" required className="form-control" value={this.state.description} onChange={this.onChangeDesciption}/>
                    </div>
                    <div className="form-group">
